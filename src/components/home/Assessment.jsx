      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-7xl mx-auto mb-16">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-black dark:text-white text-center">
            Unlock Your Future with Eklavya
          </h2>
          <p className="text-black dark:text-white leading-relaxed">
            The Eklavya Scholarship Exam is a prestigious merit-based online
            ...
            for higher education. Through Eklavya, students can confidently
            ...
            modern industry standards. Eklavya also provides advanced learning
            ...
            learning, and career-focused programs, Eklavya bridges the gap
            between education and employment. Participate in the Eklavya
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 mb-16">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm dark:shadow-none border border-gray-100 dark:border-gray-700 hover:shadow-xl dark:hover:shadow-lg dark:hover:bg-gray-750 transition-all duration-300 group">
            ...
            <p className=" mb-6">
              To apply for the Eklavya Scholarship 2026, candidates must meet
          ...
          <div className="relative z-10 px-6 py-12 md:py-16 md:px-12 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
            <div className="max-w-2xl">
              ...
              <p className="text-indigo-100 text-lg">
                The Eklavya Scholarship Exam 2026 offers you a reliable
