  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className={`${bgColor} mb-16 text-gray-900 dark:text-white p-6 rounded-lg shadow dark:shadow-none hover:shadow-md dark:hover:shadow-lg transition`}>
        <h3 className="text-2xl font-semibold text-gray-900 dark:text-gray-300 mb-6 text-center">
          Start Learning in 3 Easy Steps
        </h3>
        <ol className="space-y-6 max-w-4xl mx-auto text-lg text-gray-900 dark:text-gray-300 list-decimal list-inside">
          <li>
      ...
      <div className="text-center mb-16">
        <h3 className="text-2xl font-semibold text-gray-900 dark:text-gray-300 mb-4">
      ...
      <div className={`${bgColor} p-8 rounded-xl shadow-lg dark:shadow-none text-center`}>
        <h3 className="text-2xl font-bold text-blue-800 dark:text-gray-300 mb-4">
