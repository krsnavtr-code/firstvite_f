    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-black dark:text-white">
      <div className="text-center mb-12">
        <h2 className="text-2xl md:text-3xl font-bold text-black dark:text-white text-center">
          Welcome to Eklavya – Your Online Learning Partner
        </h2>
        <p className="mt-4">
          Eklavya is a trusted and innovative online learning platform
          ...
          <strong>online skill training courses in India</strong>, Eklavya
          ...
          That’s why Eklavya stands out as a{" "}
          ...
          mentors, flexible schedules, and career-focused curricula, Eklavya
      ...
      <div className="text-center mb-16">
        ...
        <p className="mt-4 text-lg text-black dark:text-white mx-auto">
          ...
          assistance and lifetime access to learning material — Eklavya is
      ...
      >
        ...
        <p className="text-lg text-black dark:text-white max-w-2xl mx-auto">
          Empower your future with Eklavya — where education meets
