      ...
      <div className="max-w-4xl mx-auto bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8">
        ...
        <div className="prose dark:prose-invert max-w-none">
          <p className="text-black dark:text-white mb-4">
            At FirstVite, we are committed to protecting your privacy and ensuring the security of your personal information. 
            This Privacy Policy outlines how we collect, use, and safeguard your information when you use our platform.
          </p>

          <h2 className="text-2xl font-semibold text-black dark:text-white mt-8 mb-4">1. How We Use Your Information</h2>
          <p className="text-black dark:text-white mb-4">
          ...
          <h2 className="text-2xl font-semibold text-black dark:text-white mt-8 mb-4">2. Data Security</h2>
          ...
          <h2 className="text-2xl font-semibold text-black dark:text-white mt-8 mb-4">3. Your Rights</h2>
          <p className="text-black dark:text-white mb-4">
          ...
          <h2 className="text-2xl font-semibold text-black dark:text-white mt-8 mb-4">4. Third-Party Services</h2>
          <p className="text-black dark:text-white mb-6">
          ...
          <h2 className="text-2xl font-semibold text-black dark:text-white mt-8 mb-4">5. Changes to This Policy</h2>
          <p className="text-black dark:text-white mb-6">
            We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new 
            Privacy Policy on this page and updating the "Last updated" date.
          </p>

          <h2 className="text-2xl font-semibold text-black dark:text-white mt-8 mb-4">6. Contact Us</h2>
          <p className="text-black dark:text-white mb-6">
