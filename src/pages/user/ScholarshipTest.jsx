...
const ScholarshipTest = () => {
  ...
  if (!testStarted) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex items-center justify-center p-5">
        <SEO
          title="Scholarship Test | Eklavya Centre of Excellence"
          description="Apply for the Eklavya Centre of Excellence Scholarship Test and unlock academic excellence with merit-based rewards, career guidance, and expert mentoring."
          keywords="scholarship test, scholarship evaluation, online test, Eklavya scholarship, student scholarship"
          og={{
            title: "Scholarship Test | Eklavya Centre of Excellence",
            description: "Apply for the Eklavya Centre of Excellence Scholarship Test and unlock academic excellence with merit-based rewards, career guidance, and expert mentoring.",
            type: "article",
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="text-center mb-10">
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mt-6 mb-2">
                Eklavya Scholarship Test – Online Scholarship Evaluation for
                Students
              </h1>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 mb-10 border border-gray-100">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-bold text-gray-900">
                  Scholarship Test Policy & Important Warnings – Eklavya
                </h2>
              </div>

              <div className="space-y-6 text-gray-700 leading-relaxed text-sm md:text-base">
                <p>
                  The Eklavya Scholarship Evaluation Test is designed to
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white p-4 rounded-xl border border-gray-200">
                    ...
                    <p className="text-sm text-gray-600">
                      Each question in the Eklavya scholarship exam has a
                  ...
                  <div className="bg-white p-4 rounded-xl border border-gray-200">
                    ...
                    <p className="text-sm text-gray-600">
                      ...
                      from the Eklavya scholarship program.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-4 rounded-xl border border-gray-200">
                    ...
                    <p className="text-sm text-gray-600">
                      ...
                      agree to comply with all Eklavya scholarship policies,
