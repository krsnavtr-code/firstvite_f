...
const Dashboard = () => {
  ...
  if (error) {
    ...
    return (
      <div style={{ padding: '24px', textAlign: 'center' }} className="text-black dark:text-black">
  ...
  } style={{ marginBottom: 24 }} className="text-black dark:text-white bg-gray-200 dark:bg-[#001529]">
        <Row gutter={[16, 16]}>
  ...
  } style={{ marginBottom: 24 }} className="text-black dark:text-white bg-white dark:bg-[#001529]">
          <Row gutter={[16, 16]}>
