      ...
      <nav className="fixed top-0 left-0 right-0 z-[999] bg-[#0B1C3F]/95 backdrop-blur-md flex items-center justify-between py-2.5 px-4 md:py-3 md:px-8 shadow-[0_2px_20px_rgba(0,0,0,0.25)]">
        ...
        <div className="flex gap-2.5 items-center">
          <a
            ...
            className="hidden md:flex items-center gap-1.5 bg-[#1A3D8F] text-white border-none rounded-lg py-2 px-4 text-[13px] font-semibold cursor-pointer hover:bg-[#0B1C3F] transition-colors"
          >
