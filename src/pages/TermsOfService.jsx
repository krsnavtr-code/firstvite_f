    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 pt-24 pb-16 px-4">
      <div className="max-w-4xl mx-auto bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8">
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">1. Account Registration</h2>
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">2. User Responsibilities</h2>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4">4. Payments and Refunds</h2>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
