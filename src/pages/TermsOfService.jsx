  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900">
      <SEO
        ...
        description="Review the Terms of Service for using Eklabya's learning platform. Understand your rights and responsibilities as a user of our services."
        ...
        <div className="max-w-4xl mx-auto bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8">
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <ul className="list-disc pl-6 text-black dark:text-white mb-6 space-y-2">
              ...
              <li>
                Not use the service to transmit any harmful or illegal content
              </li>
            ...
            <p className="text-black dark:text-white mb-6">
              ...
              provide notice of any changes by updating the "Last updated" date
