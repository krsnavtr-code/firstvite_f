        ...
        <div className="max-w-4xl mx-auto bg-white dark:bg-slate-800 rounded-lg shadow-lg p-8">
          ...
          <div className="prose dark:prose-invert max-w-none space-y-6 text-black dark:text-white">
            ...
            <p className="mb-4">
              ...
              posted. We recommend that you print a copy of these Legal Terms
              for your records.
            </p>
            ...
            <p className="mb-4">
              ...
              competition laws) and treaties around the world. The Content and
            ...
            <h3 className="font-bold text-lg mt-4 mb-2">Your submissions</h3>
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              feedback regarding the Services, you agree that we can use and
            ...
            <h3 className="font-bold text-lg mt-4 mb-2">Binding Arbitration</h3>
            <p className="mb-4">
              If the parties are unable to resolve the dispute through informal
              negotiation, the dispute shall be finally resolved by arbitration
              in accordance with the United Nations Commission on International
              Trade Law Arbitration Rules in force at the time of commencement
              of the arbitration. The number of arbitrators shall be 1. The
              seat, or legal place, of arbitration shall be New Delhi, India.
              The language of the proceedings shall be English. The governing
              law of these Legal Terms shall be the substantive law of India.
            </p>
            <h3 className="font-bold text-lg mt-4 mb-2">Restrictions</h3>
            <p className="mb-4">
            ...
            {/* Section 14 */}
            <h2 id="section-14" className="text-2xl font-semibold mt-8 mb-4">
              14. LIMITATIONS OF LIABILITY
            </h2>
            <p className="mb-4">
            ...
            {/* Section 15 */}
            <h2 id="section-15" className="text-2xl font-semibold mt-8 mb-4">
              15. INDEMNIFICATION
            </h2>
            <p className="mb-4">
            ...
            {/* Section 16 */}
            <h2 id="section-16" className="text-2xl font-semibold mt-8 mb-4">
              16. USER DATA
            </h2>
            <p className="mb-4">
            ...
            {/* Section 17 */}
            <h2 id="section-17" className="text-2xl font-semibold mt-8 mb-4">
              17. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
            </h2>
            <p className="mb-4">
            ...
            {/* Section 18 */}
            <h2 id="section-18" className="text-2xl font-semibold mt-8 mb-4">
              18. MISCELLANEOUS
            </h2>
            <p className="mb-4">
            ...
            {/* Section 19 */}
            <h2 id="section-19" className="text-2xl font-semibold mt-8 mb-4">
              19. CONTACT US
            </h2>
            <p className="mb-4">
