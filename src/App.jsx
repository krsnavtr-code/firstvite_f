...
// Admin redirect component to redirect users to their first accessible page
const AdminRedirect = () => {
  ...
  if (accessiblePages.length === 0) {
    // User has no permissions, redirect to unauthorized
    return <Navigate to="/unauthorized" replace />;
  }

  const firstAccessiblePage = accessiblePages[0];
  const redirectRoute = pageToRouteMap[firstAccessiblePage] || "/unauthorized";
